          ...
          <div className="col-span-1 md:col-span-7 pr-0 md:pr-12">
            <form className="space-y-12 relative z-10">
              <div className="group relative">
                ...
                <input type="text" id="name" name="name" className="w-full bg-transparent border-b border-gray-300 py-4 font-body-lg text-body-lg text-gray-900 focus:outline-none focus:border-[#C4B5FD] transition-colors" placeholder="What should I call you?" />
              </div>
              ...
              <div className="group relative">
                ...
                <input type="email" id="email" name="email" className="w-full bg-transparent border-b border-gray-300 py-4 font-body-lg text-body-lg text-gray-900 focus:outline-none focus:border-[#C4B5FD] transition-colors" placeholder="Where can I reach you?" />
              </div>
              ...
              <div className="group relative">
                ...
                <select id="project" name="project" defaultValue="" className="w-full bg-transparent border-b border-gray-300 py-4 font-body-lg text-body-lg text-gray-900 focus:outline-none focus:border-[#C4B5FD] transition-colors appearance-none cursor-pointer">
              ...
              <div className="group relative">
                ...
                <textarea id="message" name="message" rows={4} className="w-full bg-transparent border-b border-gray-300 py-4 font-body-lg text-body-lg text-gray-900 focus:outline-none focus:border-[#C4B5FD] transition-colors resize-none" placeholder="Tell me about your vision..."></textarea>
              </div>
              
              <button type="submit" className="w-full md:w-auto inline-flex justify-center items-center px-12 py-6 bg-gray-900 text-white font-label-technical text-label-technical uppercase tracking-widest hover:bg-[#C4B5FD] hover:text-gray-900 transition-colors duration-300 interactive-element group">
